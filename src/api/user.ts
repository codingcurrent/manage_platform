...
export const login = (data: loginForm) => request.post<any, loginResponseData>(loginApi,data)
export const userInfo = () => request.get<any, userInfoResponseData>(userInfoApi)
