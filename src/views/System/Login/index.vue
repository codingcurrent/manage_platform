  ...
  <div class="login">
    <el-row>
      ...
      <el-col :span="12" :xs="24">
        <el-form class="login_form" form="loginForm" :rules="rules" :model="loginForm" ref="loginForms">
          <h1>Hi~</h1>
          <h2>欢迎来到这里</h2>
          <el-form-item prop="username">
            <el-input :prefix-icon="User" v-model="loginForm.username" placeholder="请输入用户名" @keyup.enter.native="logins"></el-input>
          </el-form-item>
          <el-form-item prop="password">
            <el-input :prefix-icon="Lock" v-model="loginForm.password" placeholder="请输入密码" show-password @keyup.enter.native="logins"></el-input>
          </el-form-item>
          <el-button :loading="loading" type="primary" style="width: 100%;" @click="logins">登录</el-button>
        </el-form>
      </el-col>
    </el-row>
  </div>
